...
scanner.addListener('scan', function (qr_code_content) {
	...
	chrome.tabs.query({active: true, currentWindow: true}, function(tabs) {
		...
		$.get("https://portable-profile.herokuapp.com/controllers/get-json-user-info.php?id="+qr_code_content+"&referrer="+current_tab.title, function(user_info_json) {
...
$("#test-button").click(function() {
	...
	$.get("https://portable-profile.herokuapp.com/controllers/get-json-user-info.php?id=38", function(user_info_json) {
		console.log(user_info_json);
		user_info = JSON.parse(user_info_json);
